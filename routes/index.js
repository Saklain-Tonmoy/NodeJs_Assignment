        ...
        fs.readFile('api-data.json', { encoding: 'utf8', flag: 'r' }, function (err, data) {
          ...
          //else {
            ...
            //if (data.length != 0) {
              ...
              if (locationsFromFile.country.toLowerCase() === country && locationsFromFile.name.toLowerCase() === city) {
              ...
              // countryName = locationsFromFile.name;
              // cityName = locationsFromFile.country;
